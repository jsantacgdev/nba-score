drop function if exists game_win_probability(text);
...
as $$
  ...
  partido as (
    select g.id, g.season, g.starts_at, g.status, g.season_type, g.home_team_id, g.away_team_id
    from games g
